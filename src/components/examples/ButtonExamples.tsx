    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Button leftIcon={<Download className="h-4 w-4" />} rightIcon={<ArrowRight className="h-4 w-4" />}>
            Download & Continue
          </Button>
          <Button variant="secondary" leftIcon={<Settings className="h-4 w-4" />}>Settings</Button>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          <div className="flex gap-4">
            <Button leftIcon={<Plus className="h-5 w-5" />}>Create New Brand</Button>
            <Button variant="ghost" leftIcon={<ArrowRight className="h-4 w-4" />}>Continue</Button>
          </div>
          <div className="flex gap-4">
