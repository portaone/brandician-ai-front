...
const PaymentAmountStep: React.FC<PaymentAmountStepProps> = ({
  ...
  return (
    <div className="min-h-screen" style={{ padding: "60px 40px 80px" }}>
      <div
      ...
      >
        ...
        <div className="mb-10">
          ...
          >
            Any amount helps. You can also contribute $0 and share Brandician
            with your network instead.
          </p>
          ...
          {isZeroAmount && (
            ...
            >
              ...
              >
                <strong>$0 contribution?</strong> No problem. We'll ask you to
                share Brandician on your network — that helps us reach founders
                who need strategic branding tools.
              </p>
            </div>
          )}
        </div>
