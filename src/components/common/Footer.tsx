...
const Footer: React.FC = () => (
  <footer className="bg-[#383236] min-h-[617px] lg:h-[617px] text-white relative">
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="flex flex-col items-center lg:items-start mb-8 lg:mb-0 text-center lg:text-left">
          ...
          <div className="flex justify-center flex-col items-center lg:items-start lg:justify-start">
            <div className="flex items-center justify-center w-[60px] h-[60px] md:w-[75px] md:h-[75px] lg:w-[90px] lg:h-[90px] bg-[#7f5971] rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 262.27 260.56"
              >
                <g id="icons">
                  <path
        ...
        <div className="lg:ml-[140px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6 lg:gap-0">
          ...
          <div className="">
            ...
            <ul className="">
              <li>
                <a
                  href="https://www.brandician.eu/legal/cookie-policy/"
                  className="flex items-center text-[#FD615E] hover:text-white transition-colors duration-300 group"
                >
                  <svg
                    className="h-[16px] w-[16px] fill-[#7f5971] group-hover:fill-white"
              ...
              <li>
                <a
                  href="https://www.brandician.eu/legal/privacy-policy/"
                  className="flex items-center text-[#FD615E] hover:text-white transition-colors duration-300 group"
                >
                  <svg
                    className="h-[16px] w-[16px] fill-[#7f5971] group-hover:fill-white"
              ...
              <li>
                <a
                  href="https://www.brandician.eu/legal/terms-of-use/"
                  className="flex items-center text-[#FD615E] hover:text-white transition-colors duration-300 group"
                >
                  <svg
                    className="h-[16px] w-[16px] fill-[#7f5971] group-hover:fill-white"
      ...
      <div className="justify-center items-center flex flex-col">
        ...
        <div className="text-center mt-[10px]">
          <p className="text-[10px] md:text-[11px] lg:text-[12px] font-['Source_Sans_Pro'] font-medium uppercase text-[#B38FA5] tracking-[1.5px] lg:tracking-[2px] pb-[15px] px-4 lg:px-0">
            © 2010–{new Date().getFullYear()} LAJT d.o.o. Ljubljana, Slovenia.
            All Rights reserved.
          </p>
        </div>
      </div>
    ...
    <div className="absolute bottom-[-1px] left-0 w-full flex justify-center overflow-hidden leading-[0] rotate-180">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="340 0 20 10"
