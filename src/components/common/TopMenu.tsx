                    ...
                    {isMobileMenuOpen && (
                        ...
                        >
                            <div className="px-4 py-3 space-y-1">
                                ...
                                <button
                                    className="block w-full text-left px-3 py-2 text-[14px] font-['Source_Sans_Pro'] font-semibold uppercase tracking-[2px] text-gray-700 hover:text-[#FD615E] transition-colors">
                                    ABOUT
                                </button>
